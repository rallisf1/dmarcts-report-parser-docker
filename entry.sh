...
echo "\$dbhost = '$DB_HOST';\n" >> /dmarcts-report-parser.conf
echo "\$dbport = '$DB_PORT';\n" >> /dmarcts-report-parser.conf
echo "\$imapserver = '$IMAP_HOST';\n" >> /dmarcts-report-parser.conf
echo "\$imapuser = '$IMAP_USER';\n" >> /dmarcts-report-parser.conf
echo "\$imappass = '$IMAP_PASS';\n" >> /dmarcts-report-parser.conf
echo "\$imapport = '$IMAP_PORT';\n" >> /dmarcts-report-parser.conf
echo "\$imapssl = '$IMAP_SSL';\n" >> /dmarcts-report-parser.conf
echo "\$imaptls = '$IMAP_TLS';\n" >> /dmarcts-report-parser.conf
echo "\$tlsverify = '$TLS_VERIFY';\n" >> /dmarcts-report-parser.conf
echo "\$imapignoreerror = '$IMAP_IGNORE_ERROR';\n" >> /dmarcts-report-parser.conf
echo "\$imapreadfolder = '$IMAP_READ_FOLDER';\n" >> /dmarcts-report-parser.conf
echo "\$imapmovefolder = '$IMAP_MOVE_FOLDER';\n" >> /dmarcts-report-parser.conf
echo "\$imapmovefoldererr = '$IMAP_MOVE_FOLDER_ERR';\n" >> /dmarcts-report-parser.conf
echo "\$maxsize_xml = $MAX_SIZE_XML;\n" >> /dmarcts-report-parser.conf
echo "\$compress_xml = $COMPRESS_XML;\n" >> /dmarcts-report-parser.conf
echo "\$delete_failed = $DELETE_FAILED;\n" >> /dmarcts-report-parser.conf
